...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "AI8P"."V_DOC_TEXT_PAGINATED" ("DOC_ID", "DOC_TITLE", "FILE_NAME", "TOTAL_PAGES", "TOTAL_SIZE_KB", "TEXT_EXTRACTED", "TEXT_SUMMARY") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
    doc_id,
    doc_title,
    file_name,
