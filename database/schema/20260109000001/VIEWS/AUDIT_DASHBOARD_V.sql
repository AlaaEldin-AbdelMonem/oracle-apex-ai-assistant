...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "AUDIT_DASHBOARD_V" ("AUDIT_ID", "CREATED_AT", "APP_ID", "PAGE_ID", "USER_ID", "SESSION_ID", "MODULE_NAME", "MESSAGE", "TRACE_ID", "EXTRA_DATA", "TYPE_CODE", "TYPE_NAME", "TYPE_COLOR", "EVENT_GROUP", "EVENT_CODE", "EVENT_NAME", "EVENT_ICON") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
    a.AUDIT_ID,
    a.CREATED_AT,
    a.APP_ID,
