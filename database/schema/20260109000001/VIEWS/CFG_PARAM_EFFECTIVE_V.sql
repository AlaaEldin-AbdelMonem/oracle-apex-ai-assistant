...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "AI8P"."CFG_PARAM_EFFECTIVE_V" ("PARAM_KEY", "CATEGORY_CODE", "PARAM_NAME", "EFFECTIVE_VALUE", "DEFAULT_VALUE", "OVERRIDE_VALUE", "PARAM_SCOPE", "IS_ACTIVE") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
    p.param_key,
    p.CATEGORY_CODE,
    p.param_name,
