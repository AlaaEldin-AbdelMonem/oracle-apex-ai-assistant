...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "AI8P"."HR_VW_PAYROLL_DEPT" ("EMPLOYEE_ID", "EMPLOYEE_NAME", "JOB_TITLE", "DEPARTMENT", "GRADE", "LOCATION", "BASIC_SALARY", "CURRENCY", "EFFECTIVE_DATE") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
    e.employee_id,
