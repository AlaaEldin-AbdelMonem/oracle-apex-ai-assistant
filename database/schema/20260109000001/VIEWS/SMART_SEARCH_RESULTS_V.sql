...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "AI8P"."SMART_SEARCH_RESULTS_V" ("RESULT_NUMBER", "CHUNK_ID", "DOC_ID", "DOC_TITLE", "CHUNK_SEQUENCE", "CHUNK_TEXT", "RELEVANCE_SCORE", "RELEVANCE_PCT", "EMBEDDING_MODEL", "SEARCH_QUERY") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
