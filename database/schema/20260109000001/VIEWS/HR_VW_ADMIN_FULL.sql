...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "HR_VW_ADMIN_FULL" ("EMPLOYEE_ID", "EMPLOYEE_NAME", "EMAIL", "JOB_TITLE", "HIRE_DATE", "MANAGER_ID", "DEPARTMENT", "GRADE", "LOCATION", "BASIC_SALARY", "CURRENCY", "LEAVE_TYPE", "LEAVE_BALANCE") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT 
    e.employee_id,
