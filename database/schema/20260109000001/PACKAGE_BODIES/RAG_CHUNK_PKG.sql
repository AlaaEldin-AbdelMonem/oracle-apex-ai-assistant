--------------------------------------------------------
--  DDL for Package Body RAG_CHUNK_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "AI8P"."RAG_CHUNK_PKG" AS
 /*******************************************************************************
 *  
 *******************************************************************************/
  -------------------------------------- 
 ...
 *******************************************************************************/
  ...
  BEGIN
    dbms_output.put_line('start>RAG_CHUNK_PKG>detect_language');
 ...
 *******************************************************************************/
  ...
  BEGIN
   dbms_output.put_line('start>RAG_CHUNK_PKG>chunk_by_fixed_size');
      LOOP
 ...
 *******************************************************************************/
  ...
  FUNCTION chunk_and_embed_document(
      ...
      p_embedding_model   IN VARCHAR2 DEFAULT 'all-MiniLM-L6-v2'
       ...
       vcaller constant varchar2(70):= c_package_name ||'.chunk_and_embed_document'; 
  BEGIN
       debug_util.info( 'call',vcaller);
      RETURN 0;
