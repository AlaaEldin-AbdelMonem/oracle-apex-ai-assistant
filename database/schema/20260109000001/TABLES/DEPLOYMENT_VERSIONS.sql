...
--------------------------------------------------------
  ...
  CREATE TABLE "AI8P"."DEPLOYMENT_VERSIONS" 
 ...
 JSON ("CANARY_SCHEDULE_JSON") STORE AS ( CHUNK 8192 RETENTION MIN 1800) ;
   ...
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_VERSIONS"."DEPLOYMENT_TYPE" IS 'Type: PRODUCTION, SHADOW, CANARY, AB_TEST, DRAFT';
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_VERSIONS"."ROLLOUT_PERCENTAGE" IS 'For CANARY: percentage of users receiving this deployment (0-100)';
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_VERSIONS"."TARGET_SEGMENT_IDS" IS 'Comma-separated list of USER_SEGMENTS.segment_id values';
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_VERSIONS"."SHADOW_EXECUTION_MODE" IS 'SYNC: blocks until complete, ASYNC: fire-and-forget, SCHEDULED: batch';
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_VERSIONS"."VARIANT_LABEL" IS 'For A/B tests: A, B, C, or CONTROL';
   COMMENT ON TABLE "AI8P"."DEPLOYMENT_VERSIONS"  IS 'Master registry for Production, Shadow, A/B Test, and Canary deployment versions';
