...
--------------------------------------------------------
  ...
  CREATE TABLE "AI8P"."DEPLOYMENT_AUDIT_LOG" 
 ...
 JSON ("EVENT_METADATA") STORE AS ( CHUNK 8192 RETENTION MIN 1800) ;
   ...
   COMMENT ON COLUMN "AI8P"."DEPLOYMENT_AUDIT_LOG"."EVENT_TYPE" IS 'Type of event: CREATED, ACTIVATED, PAUSED, PROMOTED, ROLLOUT_INCREASED, etc.';
   COMMENT ON TABLE "AI8P"."DEPLOYMENT_AUDIT_LOG"  IS 'Complete audit trail of deployment lifecycle events and configuration changes';
